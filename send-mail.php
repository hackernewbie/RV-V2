...
if($_POST["foo"]==''):/* if the input is not empty it means that a SPAM BOT filled up the entire form */
	...
	$msg= '<html><body>New Email Inquiry from my Site<br /><br /><strong>Name:</strong> '.$name.'<br /><br /><strong>Email:</strong> '.$email.'<br /><br /><strong>Message:</strong> '.nl2br($message).'<br /><br /><strong>Date:</strong> '.$date.'<br /><br /><br /><small><i>From - Your website</i></small></body></html>';
